...
const BLOG = {
  AUTHOR: 'augustine', // 作者
  BIO: '枥谷', // 作者简介
  LINK: 'https://wangqiufeng.notion.site/7a561c5c13f545a7a60f721242acec5b', // 网站地址
  KEYWORDS: 'Notion, 博客, 北京房产', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '7a561c5c13f545a7a60f721242acec5b', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
